...
loading → ready confirmation on boot/wake. `disconnectedLabel` shows when the link drops.
Set any to `""` to suppress; defaults are `"ACK05 connecting…"`, `"ACK05 ready"` and
silent.
